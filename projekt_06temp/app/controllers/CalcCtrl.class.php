...
public function action_deltaSave(){
...
public $records;
public function action_deltaList(){

    $where ["ORDER"] = MAX(id);
    try{
			$this->records = getDB()->select("delta", [
                "a",
                "b",
                "c",
                "delta",
		...
		getSmarty()->assign('deltucha',$this->records);  // lista rekordów z bazy danych
